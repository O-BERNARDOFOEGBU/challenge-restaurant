  ...
  props: {
    backgroundMedia: {
      ...
      default: () => ({
        ...
        src:
          'https://images.unsplash.com/photo-1585518419759-7fe2e0fbf8a6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=924&q=80',
      }),
    },
    text: {
      type: String,
